...
public class SwaggerConfig extends WebMvcConfigurationSupport {
    ...
    public Docket api(){
        return new Docket(DocumentationType.SWAGGER_2)
        		...
        		// - Traduzindo as mensagens de ingles para português
...
//                .apis(RequestHandlerSelectors.any())
                .apis(RequestHandlerSelectors.basePackage("br.com.teste.vander.resources")) // Só listar as classes de resources
    ...
    private ApiInfo apiInfo() {
    	 return new ApiInfo(
    	 "API para cadastro de Estoque e Clientes",
    	 "Esta API é utilizada para controle e cadastro de estoque e clientes",
    	 "Versão 1.0",
    	 "Java 8",
    	 new Contact("Vander Junior", "Programador Java Sr.", "vanderjunior1@hotmail.com.com"), "", "",
    ...
    // - Personalizando o header do Post informando a URI do novo recurso
